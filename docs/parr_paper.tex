...
\subsection{Gap 1: Matrix Square Root — Cyclic Trace Property}
...
\textbf{Gap:} Direct access to Fréchet derivatives of the matrix square root
...
\subsection{Gap 2: Completely Positive Maps — Choi's Theorem}
...
\subsection{Gap 3: Quantum Perron-Frobenius — Contraction on Subspace}
...
in \texttt{lean/SovMonster\_Gaps.lean} — \textbf{zero sorry}.
...
Formalized as \texttt{congruence\_lin}, \texttt{congruence\_preserves\_psd} — \textbf{zero sorry}.
